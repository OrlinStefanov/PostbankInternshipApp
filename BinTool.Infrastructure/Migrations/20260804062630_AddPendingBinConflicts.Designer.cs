...
namespace BinTool.Infrastructure.Migrations
{
    ...
    [Migration("20260804062630_AddPendingBinConflicts")]
    partial class AddPendingBinConflicts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BinTool.Domain.Entities.RuleCriteria", b =>
                {
                    ...
                    b.HasIndex("CardSchemeId", "ProductTypeId", "RegionId")
            ...
            modelBuilder.Entity("BinTool.Domain.Entities.RuleCriteria", b =>
                {
                    ...
                    b.HasOne("BinTool.Domain.Entities.FundingType", null)
                        .WithMany("RuleCriteria")
                        .HasForeignKey("FundingTypeId");
