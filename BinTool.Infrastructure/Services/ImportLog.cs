...
internal static partial class ImportLog
{
    ...
    public static partial void Started(this ILogger logger, string fileName, string user);
    ...
    public static partial void Finished(
        this ILogger logger, string fileName, string status, int totalRows, int insertedRows,
    ...
    public static partial void ConflictsPending(
        this ILogger logger, string fileName, int conflictCount);
    ...
    public static partial void ConflictsResolved(
        this ILogger logger, int resolvedCount, string user, int updatedCount, int discardedCount);
}
