...
/// <summary>
/// What a reference-data write actually did, or why it did nothing. Shared across the
/// four named lookups and Country so a UI layer reads one shape.
/// </summary>
public enum LookupMutationStatus
{
    ...
    /// <summary>A soft-deleted row came back - either by explicit restore or by an add whose
    /// name/code was already held by a deleted row.</summary>
    Restored = 2,

    /// <summary>The row was soft-deleted. Nothing is erased.</summary>
    Deleted = 3,
    ...
    /// <summary>The supplied values broke a validation rule or referenced data that does not exist.</summary>
    Invalid = 6,
