...
public class AuditQuery
{
    ...
    /// <summary>Only entries stamped strictly before this UTC instant are returned.</summary>
    ...
    /// <summary>
    /// User name (Identity <c>UserName</c>) of whoever made the change, starts-with match and
    /// case-insensitive.
    /// </summary>
    public string? UserName { get; set; }

    /// <summary>
    /// Restricts the results to one action - Created, Updated, Deleted, Deactivated or Imported.
    /// </summary>
