...
internal static partial class CommissionRuleLog
{
    ...
    public static partial void Created(
        this ILogger logger, int ruleId, string ruleName, string user, int priority, int priorityScore);

    [LoggerMessage(EventId = 1002, Level = LogLevel.Information,
        Message = "Commission rule {RuleId} '{RuleName}' updated by {User}.")]
    public static partial void Updated(this ILogger logger, int ruleId, string ruleName, string user);

    [LoggerMessage(EventId = 1003, Level = LogLevel.Information,
        Message = "Commission rule {RuleId} '{RuleName}' deleted by {User}.")]
    public static partial void Deleted(this ILogger logger, int ruleId, string ruleName, string user);

    [LoggerMessage(EventId = 1004, Level = LogLevel.Information,
        Message = "Commission rule {RuleId} '{RuleName}' restored by {User}.")]
    public static partial void Restored(this ILogger logger, int ruleId, string ruleName, string user);

    [LoggerMessage(EventId = 1005, Level = LogLevel.Information,
        Message = "Commission rule {RuleId} '{RuleName}' set as the default by {User}.")]
    public static partial void DefaultSet(this ILogger logger, int ruleId, string ruleName, string user);
    ...
    public static partial void DefaultCleared(this ILogger logger, string user);
    ...
    public static partial void RefusedAsInvalid(this ILogger logger, string reason);
    ...
    public static partial void RefusedAsConflicting(
        this ILogger logger, int conflictingRuleId, string conflictingRuleName, string reason);
    ...
    public static partial void RefusedAsUnavailable(this ILogger logger, int ruleId, string reason);
}
